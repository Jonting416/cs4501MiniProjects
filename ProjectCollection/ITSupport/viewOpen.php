...
<body>
	<h1 align="center">Open Support Ticket Index - Unassigned Tickets</h1>
	<?php
	$ticketArray = array();
	$query = "SELECT * FROM tickets NATURAL JOIN assign WHERE adminName = \"\"";
	...
	<table align="center">
		...
		<tr><td><a href="viewMine.php"><button class="frmbtn">View My Tickets</button></a></td><td><a href="logout.php"><button class="frmbtn">Logout</button></a></td><td><a href="main.php"><button class="frmbtn">View Open Tickets</button></a></td></tr>
	</table>
</body>