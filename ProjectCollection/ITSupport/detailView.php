...
<head><title>ITSupport Detail View</title></head>
<body>
	<?php
	...
	<table align="center">
		...
		<tr><td><a href="mail.php"><button class="frmbtn">Email Submitter</button></a></td><td><a href="viewSame.php"><button class="frmbtn">Find tickets from same submitter</button></a></td></tr>
		<tr><td><a href="viewSimilar.php"><button class="frmbtn">Find all similar tickets</button></a></td><td><a href="main.php"><button class="frmbtn">Go Back to Main Page</button></a></td></tr>
	</table>
</body>
</html>