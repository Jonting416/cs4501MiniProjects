...
<body>
	<h1 align="center">Open Support Ticket Index - Your Tickets</h1>
	<?php
	$ticketArray = array();
	$myName = $_SESSION["FName"];
	$query = "SELECT * FROM tickets NATURAL JOIN assign WHERE adminName = \"$myName\"";
	...
	<table align="center">
		<tr><td><a href="viewAll.php"><button class="frmbtn">View All Tickets</button></a></td><td><input class="frmbtn" form="sorting" type="submit" value="Sort by select"></td><td><input class="frmbtn" form="buttons" type="submit" value="Detail View"></td></tr>
		<tr><td><a href="main.php"><button class="frmbtn">View Open Tickets</button></a></td><td><a href="logout.php"><button class="frmbtn">Logout</button></a></td><td><a href="viewOpen.php"><button class="frmbtn">View Unassigned Tickets</button></a></td></tr>
	</table>
</body>