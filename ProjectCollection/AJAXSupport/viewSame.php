...
<body>
	...
	foreach($ticketArray as $ticket) {
		echo "<tr><td>" . $ticket->id . "</td><td>" . $ticket->fname . "</td><td>" . $ticket->lname . "</td><td>" . $ticket->email . "</td><td>" . $ticket->subject . "</td><td>" . $ticket->timeReceived . "</td><td>" . $ticket->admin . "</td><td>" . $ticket->open . "</td><td>" . "<input type=\"radio\" name=\"pick\" value=\"$ticket->id\"></td></tr>";
	}
	...
	<button onclick="makeTable(fullTable)">View All Tickets</button>
</body>