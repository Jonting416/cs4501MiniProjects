...
<body>
	<?php
	$ticketArray = array();
	$sortValue = $_POST["pick"];
	$tempQuery = $_POST["query"];
	$query = $tempQuery . " ORDER BY $sortValue";
	...
	echo "</table>";
	?>
	<form id="buttons" action="detailView.php" method="POST">
		<input type="submit" value="Detail View">
	</form>
	<form id="sorting" action="sortedView.php" method="POST">
		<input type="hidden" name="query" value="<?php echo $tempQuery; ?>">
