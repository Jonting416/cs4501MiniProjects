<?php
	...
	$result = $db->query("INSERT INTO login (username, password, LName, FName, email, admin) VALUES
		('jonting', '$passphrase', 'Ting', 'Jon', 'jting416@gmail.com', 1),
		('admin', '$passphrase', 'User', 'Admin', 'otterrules@gmail.com', 1),
		('MarpleTest', '$passphrase', 'Marple', 'Miss', 'jting416+marple@gmail.com', 0)");
