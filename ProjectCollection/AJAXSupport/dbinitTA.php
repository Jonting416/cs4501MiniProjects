<?php
	...
	$result = $db->query("create table Login (username varchar(30) primary key not null,password char(32) not null, LName char(30) not null, FName char(30) not null, email varchar(50), admin bool)") or die ("Invalid: " . $db->error);
	...
	$result = $db->query("INSERT INTO login (username, password, LName, FName, email, admin) VALUES
		('jonting', '$passphrase', 'Ting', 'Jon', 'uva.cs4501@gmail.com', 1),
		('admin', '$passphrase', 'User', 'Admin', 'uva.cs4501@gmail.com', 1),
		('MarpleTest', '$passphrase', 'Marple', 'Miss', 'uva.cs4501+marple@gmail.com', 0)");
